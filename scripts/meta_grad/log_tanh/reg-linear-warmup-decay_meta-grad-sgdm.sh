...
# Fix regularization schedule to linear warmup then linear decay with peak 1e-2,
# add momentum to meta-grad (e.g., uses SGDM with gradient of regularized losses).

# Usage:
#   bash /projectnb/aclab/qinziz/trainit/scripts/meta_grad/log_tanh/reg-linear-warmup-decay_meta-grad-sgdm.sh
