...
#   bash scripts/batch_submit_baselines/step10k_semi_local_lr.sh
...
EXP=baseline_step10k_semi_local   
                                # experiment name; you can change if you want
PROJECT=greedy_lr_schedule      # change to your wandb project name
TOTAL_STEPS=10000               # maximum number of training steps
lrs=(3.33e-3 1e-3 3.33e-4 1e-4)  
                                # log grid of LRs
