...
#   bash scripts/batch_submit_baselines/step2k_symmetric_linear_lr.sh
...
EXP=baseline_step2k_symmetric_linear
...
for lr in "${lrs[@]}"; do
    ...
    args+=(
        ...
        "optimizer.lr_config.warmup=1000"
        "optimizer.lr_config.decay=1000"
